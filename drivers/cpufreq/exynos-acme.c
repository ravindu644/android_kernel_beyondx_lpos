...
/*Overclocking little cores to 1.96 GHz*/
static unsigned long arg_cpu_max_c1 = 1960000; /*max_cpu_freq= 1.95GHz for little cores*/
...
/*Overclocking prime cores to 2.83 Hz*/
unsigned long arg_cpu_max_c3 = 2830000; /*max_cpu_freq=3.016 GHz*/
